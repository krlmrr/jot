    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('register') }}" class="pt-8">
            ...
            <div class="relative pt-3">
                ...
                <div>
                    <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" autocomplete="email" placeholder="your@email.com">
            ...
            <div class="flex justify-between pt-8 text-white text-sm pl-1 font-bold">
